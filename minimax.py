...
class MiniMax:
    # it prints utility value of root node (assuming its max)
    # it prints names of all nodes visited during search
    def __init__(self, game_tree):
        self.game_tree = game_tree  # tree
        self.root = game_tree.root  # root
        self.currentNode = None     # currentnode
        self.successors = []        # list of nodes
        return
